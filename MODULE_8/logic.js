...
$("#factButton").on("click", function() {
	// We generate a random number between 0 and 5 (the number of facts in the booFactArray)
...
// When the taxtGreen button is pressed...
$("#textGreen").on("click", function() {
	// Change funText to green.
	$("#funText").css("color", "green")
})

// When the boxGrow buton is clicked
